...
- #7562 `1eef038` Bump transaction version default to 2 (AURdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomAUR)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomAUR)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (AURdrak)
