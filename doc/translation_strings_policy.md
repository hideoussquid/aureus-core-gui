...
This document provides guidelines for internationalization of the Aureus Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aureus_en.ts` remains unchanged.
